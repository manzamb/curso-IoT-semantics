...
String getPage() {
  ...
  html += "  if(document.getElementById('lightThresholdInput')) document.getElementById('lightThresholdInput').value = data.light.threshold;";
  ...
  html += "  if(document.getElementById('fanThresholdInput')) document.getElementById('fanThresholdInput').value = data.fan.threshold;";
  html += "}";
